...
* If *p* is prime, then for all 2 ≤ *x* ≤ *p*−2, *x*^2^ ☰ 1 (mod *p*)
...
But because 280/2 = 140, we can repeat this same trick to find that 2^140^ is a square root of unity. And this one it turns out is nontrivial:
